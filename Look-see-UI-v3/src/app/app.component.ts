...
export class AppComponent implements OnInit{
  ...
  constructor() {
    ...
    if(sessionStorage.getItem("isBetaAcknowledged")?.length){
  ...
  acknowledgeBeta(): void {
    this.isBetaAcknowledged = true
    sessionStorage.setItem("isBetaAcknowledged", JSON.stringify(this.isBetaAcknowledged))
  }
  title = 'Look-see-UI-v3';
}
