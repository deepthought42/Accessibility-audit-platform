...
@Component({
  selector: 'app-start-audit-confirm-dialog',
  templateUrl: './start-audit-confirm-dialog.html'
})
export class StartSinglePageAuditConfirmation {
  dialogRef = inject(MatDialogRef<StartSinglePageAuditConfirmation>);
