...
public class CrawlerTest {
    ...
    public void testPerformActionClick() {
        ...
        try {
            Crawler.performAction(com.looksee.browser.enums.Action.CLICK, "//button", driver);
        } catch (Exception e) {
    ...
    public void testPerformActionWithLocation() {
        ...
        try {
            Crawler.performAction(com.looksee.browser.enums.Action.CLICK, "//button", driver, location);
        } catch (Exception e) {
